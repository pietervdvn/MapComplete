...
export class ThemeMetaTagging {
   public static readonly themeName = "bookcases"
   ...
   public metaTaggging_for_note_import_public_bookcase(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

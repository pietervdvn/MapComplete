...
export class ThemeMetaTagging {
   public static readonly themeName = "hackerspaces"
   ...
   public metaTaggging_for_note_import_hackerspace(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

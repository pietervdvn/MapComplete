...
export class ThemeMetaTagging {
   public static readonly themeName = "facadegardens"

   public metaTaggging_for_facadegardens(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
   ...
   public metaTaggging_for_note_import_facadegardens(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

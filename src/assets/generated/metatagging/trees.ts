...
export class ThemeMetaTagging {
   public static readonly themeName = "trees"
   ...
   public metaTaggging_for_note_import_tree_node(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

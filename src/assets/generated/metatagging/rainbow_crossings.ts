...
export class ThemeMetaTagging {
   public static readonly themeName = "rainbow_crossings"

   public metaTaggging_for_rainbow_crossing_high_zoom(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
   ...
   public metaTaggging_for_note_import_rainbow_crossings(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

...
export class ThemeMetaTagging {
   public static readonly themeName = "advertising"
   ...
   public metaTaggging_for_note_import_advertising(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

...
export class ThemeMetaTagging {
   public static readonly themeName = "artwork"
   ...
   public metaTaggging_for_note_import_artwork(feat: Feature, helperFunctions: Record<ExtraFuncType, (feature: Feature) => Function>) {
      const {distanceTo, overlapWith, enclosingFeatures, intersectionsWith, closest, closestn, get} = helperFunctions

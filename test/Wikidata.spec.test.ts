            ...
            [
                ["Download Lion", async () => {
                    ...
                    Utils.injectJsonDownloadForTests(
                        "https://www.wikidata.org/wiki/Special:EntityData/Q140.json" ,
                        WikidataSpecTest.Q140
                    )


                    const wikidata = await Wikidata.LoadWikidataEntryAsync("Q140")
                    T.equals(2, wikidata.claims.get("P18").size)

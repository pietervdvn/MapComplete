export default {
  ...
  "$ref": "#/definitions/LayoutConfigJson",
  "definitions": {
    "LayoutConfigJson": {
      "type": "object",
      "properties": {
        "id": {
          "type": "string",
          "description": "The id of this layout.\n\nThis is used as hashtag in the changeset message, which will read something like \"Adding data with #mapcomplete for theme #<the theme id>\" Make sure it is something decent and descriptive, it should be a simple, lowercase string.\n\nOn official themes, it'll become the name of the page, e.g. 'cyclestreets' which become 'cyclestreets.html'"
        },
        "credits": {
          "type": "string",
        ...
        "maintainer": {
          "type": "string",
          "description": "Who does maintian this preset?"
        },
        "version": {
          "type": "string",
          "description": "A version number, either semantically or by date. Should be sortable, where the higher value is the later version"
        },
        "language": {
          "anyOf": [
            {
          ...
          "description": "The supported language(s). This should be a two-letter, lowercase code which identifies the language, e.g. \"en\", \"nl\", ... If the theme supports multiple languages, use a list: `[\"en\",\"nl\",\"fr\"]` to allow the user to pick any of them"
        },
        "mustHaveLanguage": {
          "type": "array",
          "items": {
        ...
        "shortDescription": {
          ...
          "description": "A short description, showed as social description and in the 'more theme'-buttons. Note that if this one is not defined, the first sentence of 'description' is used"
        },
        "description": {
          "anyOf": [
            {
        ...
        "icon": {
          "type": "string",
          "description": "The icon representing this theme. Used as logo in the more-screen and (for official themes) as favicon, webmanifest logo, ... Either a URL or a base64 encoded value (which should include 'data:image/svg+xml;base64)"
        },
        "socialImage": {
          "type": "string",
          "description": "Link to a 'social image' which is included as og:image-tag on official themes. Useful to share the theme on social media. See https://www.h3xed.com/web-and-internet/how-to-use-og-image-meta-tag-facebook-reddit for more information"
        },
        "startZoom": {
          "type": "number",
          "description": "Default location and zoom to start. Note that this is barely used. Once the user has visited mapcomplete at least once, the previous location of the user will be used"
        },
        "startLat": {
          "type": "number"
        },
        ...
        "widenFactor": {
          "type": "number",
          "description": "When a query is run, the data within bounds of the visible map is loaded. However, users tend to pan and zoom a lot. It is pretty annoying if every single pan means a reloading of the data. For this, the bounds are widened in order to make a small pan still within bounds of the loaded data.\n\nIF widenfactor is 1, this feature is disabled. A recommended value is between 1 and 3"
        },
        "overpassMaxZoom": {
          "anyOf": [
            {
          ...
          "description": "At low zoom levels, overpass is used to query features. At high zoom level, the OSM api is used to fetch one or more BBOX aligning with a slippy tile. The overpassMaxZoom controls the flipoverpoint: if the zoom is this or lower, overpass is used."
        },
        "osmApiTileSize": {
          "type": "number",
          "description": "When the OSM-api is used to fetch features, it does so in a tiled fashion. These tiles are using a ceratin zoom level, that can be controlled here Default: overpassMaxZoom + 1"
        },
        "overrideAll": {
        ...
        "clustering": {
          ...
          "properties": {
            "maxZoom": {
              "type": "number",
              "description": "All zoom levels above 'maxzoom' are not clustered anymore. Defaults to 18"
            },
            "minNeededElements": {
              "type": "number",
              "description": "The number of elements per tile needed to start clustering If clustering is defined, defaults to 25"
            }
          },
          "description": "If defined, data will be clustered. Defaults to {maxZoom: 16, minNeeded: 500}"
        },
        "customCss": {
          "type": "string",
        ...
        "lockLocation": {
          ...
          "description": "If set to true, the basemap will not scroll outside of the area visible on initial zoom. If set to [[lat0, lon0], [lat1, lon1]], the map will not scroll outside of those bounds. Off by default, which will enable panning to the entire world"
        },
        "enableUserBadge": {
          "type": "boolean"
        },

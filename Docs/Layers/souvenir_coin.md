...
*   _A souvenir coin costs 2 euro_ corresponds with [charge](https://wiki.openstreetmap.org/wiki/Key:charge)\=[2 EUR](https://wiki.openstreetmap.org/wiki/Tag:charge%3D2 EUR)

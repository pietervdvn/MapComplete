...
This document is autogenerated from [assets/layers/lighthouse/lighthouse.json](https://source.mapcomplete.org/MapComplete/MapComplete/src/branch/develop/assets/layers/lighthouse/lighthouse.json)

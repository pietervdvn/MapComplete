...
The question is  *Does this shoe repair shop repair climbing shoes?*
  ...
  - *This shop repairs climbing shoes*  corresponds with  `service:repair:climbing_shoes=yes`
  - *This shop does not repair climbing shoes*  corresponds with  `service:repair:climbing_shoes=no`

...
This document is autogenerated from [assets/layers/parking/parking.json](https://source.mapcomplete.org/MapComplete/MapComplete/src/branch/develop/assets/layers/parking/parking.json)

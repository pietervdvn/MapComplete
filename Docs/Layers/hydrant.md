...
This document is autogenerated from [assets/layers/hydrant/hydrant.json](https://source.mapcomplete.org/MapComplete/MapComplete/src/branch/develop/assets/layers/hydrant/hydrant.json)

...
0.  [amenity](https://wiki.openstreetmap.org/wiki/Key:amenity)\=[shelter](https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dshelter)
1.  [shelter\_type](https://wiki.openstreetmap.org/wiki/Key:shelter_type)\=[public\_transport](https://wiki.openstreetmap.org/wiki/Tag:shelter_type%3Dpublic_transport)

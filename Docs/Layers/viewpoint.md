...
Elements must match the expression **[tourism](https://wiki.openstreetmap.org/wiki/Key:tourism)\=[viewpoint](https://wiki.openstreetmap.org/wiki/Tag:tourism%3Dviewpoint)**
...
The question is _Do you want to add a description?_

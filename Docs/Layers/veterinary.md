...
Elements must match the expression **[amenity](https://wiki.openstreetmap.org/wiki/Key:amenity)\=[veterinary](https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dveterinary)**
...
The question is _What is the name of this veterinarian?_

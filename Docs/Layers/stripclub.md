...
The following options to create new points are included:
 ...
 - **a stripclub** which has the following tags:<a href='https://wiki.openstreetmap.org/wiki/Key:amenity' target='_blank'>amenity</a>=<a href='https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dstripclub' target='_blank'>stripclub</a>

## Basic tags for this layer

Elements must match the expression **<a href='https://wiki.openstreetmap.org/wiki/Key:amenity' target='_blank'>amenity</a>=<a href='https://wiki.openstreetmap.org/wiki/Tag:amenity%3Dstripclub' target='_blank'>stripclub</a>**
...
*This stripclub is named <b>{name}</b>* is shown if `name` is set
...
This document is autogenerated from [assets/layers/stripclub/stripclub.json](https://source.mapcomplete.org/MapComplete/MapComplete/src/branch/develop/assets/layers/stripclub/stripclub.json)

...
This rendering asks information about the property  [note:design_count](https://wiki.openstreetmap.org/wiki/Key:note:design_count) This is rendered with  `This machine has {note:design_count} designs available.`

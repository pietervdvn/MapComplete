...
| <a target="_blank" href='https://taginfo.openstreetmap.org/keys/note:design_count#values'><img src='https://mapcomplete.org/assets/svg/search.svg' height='18px'></a> <a target="_blank" href='https://taghistory.raifer.tech/?#***/note%3Adesign_count/'><img src='https://mapcomplete.org/assets/svg/statistics.svg' height='18px'></a> [note:design_count](https://wiki.openstreetmap.org/wiki/Key:note:design_count) | [pnat](../SpecialInputElements.md#pnat) | [1](https://wiki.openstreetmap.org/wiki/Tag:note:design_count%3D1) [2](https://wiki.openstreetmap.org/wiki/Tag:note:design_count%3D2) [3](https://wiki.openstreetmap.org/wiki/Tag:note:design_count%3D3) [4](https://wiki.openstreetmap.org/wiki/Tag:note:design_count%3D4) |
...
This document is autogenerated from [assets/layers/souvenir_note/souvenir_note.json](https://source.mapcomplete.org/MapComplete/MapComplete/src/branch/develop/assets/layers/souvenir_note/souvenir_note.json)

...
## Circular economy ( [circular_economy](https://mapcomplete.org/circular_economy) )
_This document details some technical information about this MapComplete theme, mostly about the attributes used in the theme. Various links point toward more information about the attributes, e.g. to the OpenStreetMap-wiki, to TagInfo or tools creating statistics_
The theme introduction reads:

> Various items which help people to share, reuse or recycle.
...
This theme contains the following layers:
 ...
 - [shops_second_hand (defined in this theme)](#shops_second_hand)
...
# Table of contents
  ...
  - [Circular economy ( circular_economy )](#circular-economy-(-circular_economy-))
